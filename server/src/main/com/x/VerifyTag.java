 ...
 */
@WebServlet(asyncSupported = true, urlPatterns = { "/VerifyTag" })
public class VerifyTag extends HttpServlet {

  private static final Logger LOG = Logger.getLogger(VerifyTag.class);
